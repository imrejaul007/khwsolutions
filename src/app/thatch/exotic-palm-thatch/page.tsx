...
export default function PalmThatchPage() {
  ...
  const features = [
    { icon: "🛡", text: "No Waterproof Membrane Required" },
    { icon: "✓", text: "20-Year Warranty" },
    { icon: "∞", text: "50 Years Life Expectancy" },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "0.75rem", marginBottom: "2rem" }}>
            {features.map((f, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                <div style={{ width: 32, height: 32, borderRadius: "50%", background: "var(--forest)", color: "var(--white)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.875rem", fontWeight: 700, flexShrink: 0 }}>
                  {f.icon}
                </div>
                <span style={{ fontFamily: "var(--font-heading)", fontSize: "0.625rem", fontWeight: 600, color: "var(--ink)", letterSpacing: "0.05em", textTransform: "uppercase" }}>{f.text}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            <div style={{ display: "flex", gap: "0" }}>
              <button
                ...
                style={{
                  padding: "1rem 1.5rem",
                  background: selectedVariant === "without" ? "var(--forest)" : "var(--white)",
                  color: selectedVariant === "without" ? "var(--white)" : "var(--ink)",
              ...
              <button
                ...
                style={{
                  padding: "1rem 1.5rem",
                  background: selectedVariant === "with" ? "var(--gold)" : "var(--white)",
                  color: selectedVariant === "with" ? "var(--white)" : "var(--ink)",
            ...
            <div className="container">
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(3rem, 6vw, 6rem)", alignItems: "start" }}>
                ...
                <div>
                  ...
                  <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(2rem, 4vw, 3.5rem)", fontWeight: 700, color: "var(--ink)", lineHeight: 0.9, textTransform: "uppercase", marginBottom: "2rem" }}>
                    Without<br />Rails
                  </h2>
                  <div style={{ width: 60, height: 3, background: "var(--gold)", marginBottom: "2rem" }} />
                  <p style={{ fontFamily: "var(--font-body)", fontSize: "1rem", color: "var(--ink-muted)", lineHeight: 1.8, marginBottom: "2rem" }}>
              ...
              {/* Feature Bar */}
              <div style={{ display: "flex", justifyContent: "center", gap: "clamp(1rem, 3vw, 3rem)", marginTop: "4rem", flexWrap: "wrap" }}>
                {features.map((f, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    <div style={{ width: 8, height: 8, borderRadius: "50%", background: "var(--gold)" }} />
                    <span style={{ fontFamily: "var(--font-heading)", fontSize: "0.6875rem", fontWeight: 600, color: "var(--ink)", textTransform: "uppercase", letterSpacing: "0.05em" }}>{f.text}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(3rem, 6vw, 6rem)", alignItems: "start" }}>
                ...
                <div>
                  ...
                  <p style={{ fontFamily: "var(--font-body)", fontSize: "1rem", color: "var(--ink-muted)", lineHeight: 1.8, marginBottom: "1.5rem" }}>
                    This variant of KHW's Exotic Nipa palm thatch leaves comes along with special Aluminium rail accessories and is installed directly on any roofing frame, either made of metal, wood or bamboo.
                  </p>
                  <p style={{ fontFamily: "var(--font-body)", fontSize: "1rem", color: "var(--ink-muted)", lineHeight: 1.8, marginBottom: "2rem" }}>
                  ...
                  <p style={{ fontFamily: "var(--font-body)", fontSize: "1rem", color: "var(--ink)", lineHeight: 1.7 }}>
