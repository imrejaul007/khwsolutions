...
export default function BambooMatsPage() {
  const bamboo = products.find((p) => p.id === "bamboo-products");
  const product = bamboo?.subProducts.find((p) => p.id === "bamboo-mats");
  ...
  const weavePatterns = [
    {
      name: "Open Weave",
      desc: "Airy, light-filtering pattern with visible gaps between bamboo strips. Creates dappled light effects when used as ceiling panels.",
      visual: "open",
    },
    {
      name: "Tight Weave",
      desc: "Dense bamboo weave providing complete coverage and privacy. Best for walls and fence infills where opacity is required.",
      visual: "tight",
    },
    {
      name: "Herringbone",
      desc: "Diagonal interlocking weave pattern for a more decorative, artisanal look. Popular in feature wall and gate panel applications.",
      visual: "herringbone",
    },
  ];
    ...
    <>
      ...
      <section className="product-hero" style={{ background: "var(--bark)" }}>
        <div style={{ position: "relative", overflow: "hidden" }}>
          <img
            src="/images/bamboo/bamboo-mats-hero.png"
            alt="Bamboo Mats"
        ...
        >
          ...
          >
            ...
            <span>/</span>
            <Link href="/bamboo" style={{ color: "inherit" }}>
              Bamboo
            </Link>
            <span>/</span>
            <span style={{ color: "var(--ink)" }}>Mats</span>
          </div>
          <h1
            style={{
              fontFamily: "var(--font-heading)",
          ...
          />
          <p
            style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(0.875rem, 1.5vw, 1.125rem)", fontWeight: 400, color: "var(--ink-muted)", lineHeight: 1.7, marginBottom: "2.5rem" }}
          >
            {product.description}
          </p>
          <div className="split-2--stats" style={{ marginBottom: "2rem" }}>
            {[
              { value: "8ft × 4ft", label: "Standard Size" },
              { value: product.warranty, label: "Warranty" },
              { value: "3 Patterns", label: "Weave Styles" },
              { value: "3 Colors", label: "Wood Tones" },
            ].map((stat) => (
              <div
                key={stat.label}
                style={{
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            ...
            <a
              href={`https://wa.me/919148584281?text=Hi%20KHW!%20I%27m%20interested%20in%20Bamboo%20Mats.`}
              target="_blank"
      ...
      <section className="section bg-cream">
        <div className="container">
          ...
          >
            Hand-woven by skilled artisans using all-weather synthetic rattan.
            Each pattern creates a different visual density and texture.
          </p>
          <div className="split-2--3">
            {weavePatterns.map((p, i) => (
              <div key={p.name}>
                          ...
                          {Array.from({ length: 30 }).map((_, idx) => (
                            <g key={idx}>
                              <rect
                                ...
                                opacity={0.6}
                                rx="1"
                                transform={`rotate(45 ${idx * 22 - 300 + 1.5} 120)`}
                              />
                              <rect
                                x={idx * 22 - 300}
                                y="20"
      ...
      <section className="section bg-white">
        <div className="container">
          ...
          >
            {product.colors.length} Wood-Tone
            <br />
            <span style={{ fontStyle: "italic", color: "var(--gold)" }}>Colors</span>
          </h2>
                ...
                {product.applications.map((app) => (
                  <div
                    ...
                    style={{
                      ...
                      background: "var(--white)",
                      borderLeft: "3px solid var(--bark-mid)",
                      display: "flex",
                      alignItems: "center",
                      gap: "0.75rem",
                    }}
              ...
              .map((p) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        src={`/images/bamboo/${p.id.replace(
                          "bamboo-",
                          ""
                        )}-splash.png`}
                        alt={p.name}
          ...
          >
            <div>
              <h2
                ...
                style={{ color: "var(--cream)", marginBottom: "0.5rem" }}
              >
                Get a Free Quote for Bamboo Mats
              </h2>
              <p
                className="body-sm"
                style={{ color: "rgba(248,243,236,0.6)" }}
              >
                Contact us for pricing, samples, and weave pattern recommendations.
              </p>
            </div>
            <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
              <a
                href="https://wa.me/919148584281?text=Hi%20KHW!%20I%27m%20interested%20in%20Bamboo%20Mats.%20Please%20share%20pricing%20and%20samples."
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: "inline-block",
